...
const Borrower: FormFields[] = [
    ...
    },
    {
        id : "birth_date",
        label : "Birth date",
        validation : Yup.date().required("Birthdate is required").test('is-old_enough', 'You muse be atleast 21 years old', (value) => {
            ...
            return age > 21 || (age === 21 && monthDifference > 0) || (age === 21 && monthDifference === 0 && dayDifference >= 0);
        }),
        component : 'date',
        width : 12
    }
